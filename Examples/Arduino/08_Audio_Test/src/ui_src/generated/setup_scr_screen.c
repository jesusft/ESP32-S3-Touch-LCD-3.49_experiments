...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_label_set_text(ui->screen_label_1, "audio test");
    ...
    lv_obj_set_style_text_color(ui->screen_label_1, lv_color_hex(0x0f908e), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_2, "正常录音，正在播放，录音完成，播放完成，等待操作，音乐");
    lv_label_set_long_mode(ui->screen_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_2, 0, 79);
    lv_obj_set_size(ui->screen_label_2, 172, 32);
    ...
    lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_Bold_19, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_label_3, "Waiting for Operation");
    lv_label_set_long_mode(ui->screen_label_3, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_label_3, 0, 126);
    lv_obj_set_size(ui->screen_label_3, 172, 32);
    ...
    lv_obj_set_style_text_font(ui->screen_label_3, &lv_font_Bold_19, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_btn_2, 0, 443);
